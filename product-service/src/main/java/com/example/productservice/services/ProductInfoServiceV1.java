...
public class ProductInfoServiceV1 {

    private final RestTemplate restTemplate;

    private ProductDetail getProductDetailsCall(long productId) {
        ProductDetail productDetails = this.restTemplate.getForObject("http://product-details-service/product-details/" + productId, ProductDetail.class);
...
//        CircuitBreaker circuitBreaker = CircuitBreaker.ofDefaults("productDetailsService");
//        Supplier<ProductDetail> supplier = CircuitBreaker.decorateSupplier(circuitBreaker, this::getProductDetailsCall);
